...
import { PieChart, Pie, Cell, ResponsiveContainer, LineChart, Line, XAxis, YAxis, Tooltip, Area, AreaChart, BarChart, Bar } from "recharts";
...
export default function Home() {
    ...
    <>
      <div className="min-h-screen bg-[#050b1f] relative">
        ...
        <div className="relative z-10">
          ...
          <div className="sticky top-2 sm:top-4 z-50 max-w-7xl mx-auto px-3 sm:px-6">
            <div className="bg-[#0d1b3a]/95 backdrop-blur-md rounded-full border border-[#14b8a6]/20 shadow-xl px-4 sm:px-6 md:px-8 py-3 sm:py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  />
                  <span className="text-gray-400 text-xs sm:text-sm md:text-base font-bold hidden sm:inline">pNode Analytics</span>
                </div>
                ...
                <nav className="hidden lg:flex items-center gap-6 xl:gap-10">
                  <button
                    ...
                    className={`text-base font-bold transition-colors ${currentView === "overview"
                        ? "text-white"
                ...
                >
                  <nav className="flex flex-col p-4 gap-2">
                    <button
                      ...
                      className={`text-left px-4 py-3 rounded-lg text-base font-bold transition-colors ${currentView === "overview"
                    ...
                    <Link
                      ...
                      className="text-left px-4 py-3 rounded-lg text-base font-bold text-gray-300 hover:bg-white/5 transition-colors flex items-center gap-2 block"
                    >
                      <span className="text-yellow-400 text-lg">💡</span>
                      Analytics
                    </Link>
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm text-gray-400 mb-3 sm:mb-4">
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                      ...
                      <span>nodes</span>
                      <span>·</span>
                      <span className="text-[#14b8a6] font-medium">{stats.active}</span>
                      <span>active</span>
                      <span>·</span>
                      <span className="text-white font-medium">{stats.versions}</span>
                      <span>versions</span>
                      <span>·</span>
                      <span className="text-white font-medium">{stats.uniqueIPs}</span>
                      <span>IPs</span>
                  ...
                  <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-4 py-2">
                    ...
                    <div className="flex items-center gap-1.5 md:gap-2">
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-black transition-all ${filterStatus === "all"
                            ? "bg-[#14b8a6] text-white"
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-black transition-all ${filterStatus === "active"
                            ? "bg-[#14b8a6] text-white"
                            : "text-gray-300 hover:text-white hover:bg-[#14b8a6]/10"
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-black transition-all ${filterStatus === "warning"
                            ? "bg-[#14b8a6] text-white"
                            : "text-gray-300 hover:text-white hover:bg-[#14b8a6]/10"
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-black transition-all ${filterStatus === "offline"
                            ? "bg-[#14b8a6] text-white"
                            : "text-gray-300 hover:text-white hover:bg-[#14b8a6]/10"
                          }`}
                      >
            ...
            {selectedNode && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed right-0 top-0 h-full w-full sm:w-[90%] md:w-[600px] bg-[#0d1425]/98 backdrop-blur-md z-50 overflow-y-auto shadow-2xl border-l border-[#14b8a6]/30"
                >
  ...
  <>
    ...
    {/* Help Bot */}
    <HelpBot stats={{ total: stats.total, active: stats.active, warning: stats.warning, offline: stats.offline, versions: stats.versions, uniqueIPs: stats.uniqueIPs }} />
  </>
);
